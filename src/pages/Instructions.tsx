              ...
              <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg flex items-start space-x-3">
                ...
                <div>
                  ...
                  <ul className="mt-2 space-y-1 text-yellow-800">
                    ...
                    <li>• Koristite odgovarajuće debljine žica za motor i napajanje</li>
                  </ul>
                </div>
              </div>
            </div>
...
void handleSettings() {
  if (server.hasArg("plain")) {
    ...
    if (!error) {
      ...
      if (doc.containsKey("pwmFreq")) {
        int newFreq = doc["pwmFreq"];
            ...
            <div className="space-y-4">
              <ol className="space-y-4">
                ...
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="font-medium">Testirajte kontrolu motora</p>
                    <p className="text-gray-600 mt-1">Koristite kontrole u aplikaciji za upravljanje motorom i proverite da li sve radi ispravno</p>
                  </div>
                </li>
              </ol>
